                ...
                <div class="col-lg-4" data-aos="fade-up" data-aos-delay="100">
                    <div class="service-box">
                        ...
                        <div class="services-list">
                            ...
                            <a href="#" class="active" style="background-color: #af1e1e; color: white;"><i class="bi bi-arrow-right-circle"></i><span>Isi Survey IKM Pembinaan</span></a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body p-4">
                        ...
                        <style>
                            .btn-check:checked + .btn {
                                background-color: #871919; /* warna hijau bootstrap */
                                border-color: #871919;
                                color: #fff;
                            }
                        </style>
                                ...
                                <div class="card mb-3">
                                    <div class="card-body">
                                        ...
                                        <div class="form-check-inline mb-2">
                                            ...
                                            <label for="{{ $pertanyaan->unsur->kd_unsur }}_{{ $index }}"class="btn btn-info">{{ $jawaban->teks_pilihan }}</label>
                                        </div>
                                        @endforeach
                                    </div>
                                </div>
